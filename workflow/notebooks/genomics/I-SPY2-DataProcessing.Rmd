...
* Final dataset: **982 patients × 18,348 genes**
...
* **Visualization:** Volcano plots showing log2 fold change vs –log10 adjusted p-value
* **Total DE Genes Identified:** 5,870

#### Full dataset analysis (no subsetting)

```{r DEG- Full dataset analysis,fig.width=10, fig.height=10}
...
```{r pathway analysis,fig.width=8, fig.height=10}
